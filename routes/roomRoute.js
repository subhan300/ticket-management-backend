...
const {
  ...
  deleteRoomsInBulk,
  getRoomsByUnitId,getRoomsByLocationId,updateBulkRooms,getStorageRooms,getRoomsByMultipleUnit
...
router.post("/multiple-unit",authenticateJWT, getRoomsByMultipleUnit);
