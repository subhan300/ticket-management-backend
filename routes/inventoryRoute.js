...
router.get('/location/:id', authenticateJWT, inventoryController.getInventoryItemsByLocation);
router.get('/location/short-details/:id', authenticateJWT, inventoryController.getInventoryItemShortDetailByLocation);
