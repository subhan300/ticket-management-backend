...
const groupTicketRoute = require("./routes/groupTicketRoute");
...
const helpGuideRoute = require("./routes/guideVideosRoute");
...
app.use("/api/group-ticket", groupTicketRoute);
...
app.use("/api/help-guide", helpGuideRoute);
